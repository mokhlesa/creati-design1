...
class TeacherRequestApproved extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ->subject('تمت الموافقة على طلبك للانضمام كمعلم')
                    ->greeting("مرحباً {$userName},")
                    ->line('يسرنا إعلامك بأنه قد تمت الموافقة على طلبك للانضمام إلى فريق المعلمين لدينا.')
